                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="single-latest-news">
                            ...
                            <div class="news-text-box">
                                <h3><a href="articulos/articulo_1.jsp">Why the berries always look delecious</a></h3>
                                <p class="blog-meta">
                                    <span class="author"><i class="fas fa-user"></i> Admin</span>
                                    <span class="date"><i class="fas fa-calendar"></i> 27 December, 2019</span>
                                </p>
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="single-latest-news">
                            <a href="articulos/articulo_1.jsp"><div class="latest-news-bg news-bg-6"></div></a>
                            <div class="news-text-box">
                        ...
                        <div class="row">
                            <div class="col-lg-12 text-center">
                                <div class="pagination-wrap">
                                    <ul>
                                        <li><a href="">Prev</a></li>
                                        <li><a class="active" href="news_1.jsp">1</a></li>
                                        <!--  
                                        <li><a href="#">2</a></li>
                                        <li><a href="#">3</a></li>
                                        -->
